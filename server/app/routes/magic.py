    ...
    if job.ai_analysis_json:
        try:
            ...
            review = MagicReviewData(
                ...
                problem=ai_data.get("problem", ""),
                targetAudience=ai_data.get("targetAudience") or ai_data.get("who") or ai_data.get("target_audience") or "",
                solution=ai_data.get("solution", ""),
                whyNow=ai_data.get("whyNow") or ai_data.get("why_now") or "",
